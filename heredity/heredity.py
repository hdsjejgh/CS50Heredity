...
def joint_probability(people, one_gene, two_genes, have_trait):
    ...
    for person in people:
        ...
        if people[person]['mother'] is None:
            ...
            percentages = {} #chance parents gave a gene

            for per in (mother, father):
                traitNum = 2 if per in two_genes else 1 if per in one_gene else 0
                chance = PROBS['mutation'] if traitNum ==0 else 0.5 if traitNum==1 else 1-PROBS['mutation']
                percentages[per] = chance
